...
- compact embedded RomFS bank: approximately 10.16 MiB on the `.3dsx` image.

Counting both the embedded 10.16 MiB RomFS bank image and its preloaded PCM copy
pessimistically as resident, the project's explicit allocations remain below
21 MiB before Citro2D, libctru, emulator/system services, stacks and allocator
